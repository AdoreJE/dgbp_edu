package ieetubase.common.config;
...
import ieetubase.common.ckeditor.CkFilter;
import ieetubase.common.filter.CorsFilter;
import ieetubase.common.filter.HTMLTagFilter;
import ieetubase.common.filter.HttpPreProcessFilter;
import ieetubase.common.filter.SessionTimeoutCookieFilter;
...
//		}
        ...
        FilterRegistration.Dynamic httpPreProcessFilter = servletContext.addFilter("httpPreProcessFilter", new HttpPreProcessFilter());
        httpPreProcessFilter.addMappingForUrlPatterns(null, false, "*");
